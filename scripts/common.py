...
DOMAIN = "factory_insight"
DOMAIN_UPPER = "FACTORY_INSIGHT"
MCP_SERVER_DIR = "factory-insight-mcp-server"
MCP_SERVER_NAME = "工厂信息分析洞察"
REPORT_BANNER = "工厂信息分析报告"
REPORT_TYPE = "factory_insight_analysis"
